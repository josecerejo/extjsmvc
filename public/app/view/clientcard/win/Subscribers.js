Ext.define('ExtMVC.view.clientcard.win.Subscribers', {
  ...
  initComponent: function() {
    ...
    var clientCard = Ext.create('ExtMVC.util.ClientOLD', {
      pageUuid: pageUuid,
      headerLoadMask: Ext.LoadMask(cmp, {
    ...
    var subscribersStore = new Ext.data.Store({
      fields: [
      ...
      listeners: {
        selectionchange: function(selmodel, selected, eOpts) {
          if (selected && selected.length) {
            ...
            ExtMVC.util.Client.selectAndLoadSubscriber(selected[0].get('id'));
